      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-10">
          ...
          <div className="bg-primary-50 border-l-4 border-primary-600 rounded-r-lg p-6 mb-4">
            <p className="text-gray-700 leading-relaxed mb-3">
              Movido pelo desejo de ajudar e servir,{" "}
              <strong>Antonio Tito:</strong>
            </p>
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              <li>Fotografou os livros do acervo</li>
              <li>
                Auxiliou no levantamento de informações como título e autor
              </li>
              <li>
                Teve a iniciativa inicial de buscar uma forma prática de apoiar
                o padre na catalogação de sua biblioteca
              </li>
            </ul>
          </div>
          <p className="text-gray-700 leading-relaxed">
            ...
            ao próximo, colocando o tempo e os talentos a serviço da Igreja.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <strong>voluntária e gratuita</strong>, em espírito de serviço e
            ...
            <div className="space-y-2 text-gray-700">
              <p className="flex items-center">
                ...
                <span>
                  Site:{" "}
                  <a
                    href="https://www.admtecnologia.com.br"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-primary-600 hover:text-primary-700 underline"
                  >
                    www.admtecnologia.com.br
                  </a>
                </span>
              </p>
              <p className="flex items-center">
